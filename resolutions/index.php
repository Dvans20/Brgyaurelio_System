...
<?php 
    ...
    $resolutions = Resolution::find("","", "", $currentPage, $limit);

    $totalPages = ceil(Resolution::countAll("","", "") / $limit);
?>
...
<html lang="en">
    ...
    rgba(255,255,255,0), #13547a), url('../admin/Media/images/resolutions_cover.jpg?v=<?php echo(time().uniqid()); ?>');">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <h2 class="text-white">Issuances</h2>
                        </div>
                                ...
                                <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                                    <div class="d-flex">
                                        ...
                                        <div class="custom-block-topics-listing-info d-flex">
                                            <div>
                                                <h5 class="mb-2"><?php echo($resolution->resolutionTitle); ?> No. 
                                                    <?php echo($resolution->resolutionNo); ?>
                                                    <small><i class="fs-6"> Series of: <?php echo($resolution->yearSeries); ?></i></small>
                                                </h5>
                                                ...
                                                <a href="../admin/Media/pdf/<?php echo($resolution->pdfFile); ?>" target="_blank" class="btn custom-btn mt-3 mt-lg-4">
                        ...
                        <?php if ($totalPages > 1 && !empty($currentPage)) { ?>
                            ...
                            <div class="col-lg-12 col-12">
                                <ul class="pagination justify-content-center mb-0">
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo($web->siteUrl . "/resolutions?page=" . $prevPage); ?>" aria-label="Previous">
                                    ...
                                    <?php for ($page = 1; $page <= $totalPages; $page++) { ?>
                                        ...
                                        <?php } else if (($currentPage >= $page - 3) && ($currentPage <= $page + 3)) { ?>
                                            <li class="page-item" aria-current="page">
                                                <a class="page-link" href="<?php echo($web->siteUrl . "/resolutions?page=" . $page); ?>"><?php echo($page); ?></a>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>

                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo($web->siteUrl . "/resolutions?page=" . $nextPage); ?>" aria-label="Next">
